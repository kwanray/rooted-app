...
export default function FoundationBar({ completed, currentIdx, startingIdx = 0, onNavigate }: Props) {
  return (
    <div className="w-full px-3 py-3">
      <div className="flex gap-1.5 justify-center flex-wrap">
        {POINTS.map((pt, i) => {
          ...
          const isClickable = !!(onNavigate && (isDone || isCurrent))
          ...
          return (
            <div
              ...
              onClick={() => { if (isClickable) onNavigate!(i) }}
              style={{
                width: 28,
                height: 28,
                background: bg,
