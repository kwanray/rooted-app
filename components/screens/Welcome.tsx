...
const POINT_ICONS: Record<string, React.ReactNode> = {
  ...
  '08': <svg viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" width="22" height="22"><line x1="1" y1="20" x2="23" y2="20"/><path d="M4 20 Q4 8 12 8 Q20 8 20 20"/><path d="M8 20 Q8 12 12 12 Q16 12 16 20"/><circle cx="19" cy="14" r="2.5"/></svg>,
