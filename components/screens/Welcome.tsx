...
const POINT_ICONS: Record<string, React.ReactNode> = {
  ...
  '02': <svg viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" width="22" height="22"><path d="M12 3v18M3 9l4-4 4 4M17 9l4-4-4-4"/><path d="M3 9h8M13 5h8"/><path d="M5 9c0 2.5-2 4-2 4s2 1.5 2 4H3"/><path d="M19 5c0 2.5 2 4 2 4s-2 1.5-2 4h-2"/><line x1="3" y1="17" x2="7" y2="17"/><line x1="17" y1="13" x2="21" y2="13"/></svg>,
