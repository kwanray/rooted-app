...
export const POINTS: Point[] = [
  {
    ...
    claim: `Truth exists, it is knowable, and religious truth is no exception — every worldview that denies this defeats itself.`,
    sg: `Singapore prizes pragmatism — "does it work?" But the moment something works better, you're already claiming one thing is truer than another. Singapore's multicultural harmony is a social value — but it cannot mean contradictory religious truth claims are all simultaneously correct. Honouring all people does not require pretending all claims are equal. The relativist who says "that's true for you but not for me" is making a statement they intend to be universally true — which is precisely the kind of self-defeat Geisler exposes.`,
    specialViz: null,
    geisler: [
      {
        head: `The Self-Defeating Test`,
        body: `Ask anyone who says "truth doesn't exist" — is that true? If yes, they've just stated a truth. If no, they've admitted truth exists. The statement "truth does not exist" self-destructs the moment it's spoken. Geisler calls this a self-defeating statement — it cannot be true without being false. Like saying "I cannot speak a word in English" — in English.`,
      },
      {
        head: `What Would a World Without Truth Look Like?`,
        body: `If truth doesn't exist, nothing is real, nothing is false, nothing matters more than anything else. Science collapses. Justice becomes meaningless. The question "does truth exist?" becomes pointless. But we live as if truth exists every day. When you say someone lied to you, you're appealing to truth. When you trust a doctor's diagnosis, you're assuming truth is knowable. We cannot function without it.`,
      },
      {
        head: `Truth Is Discovered, Not Invented`,
        body: `Truth is that which corresponds to reality — independently of what anyone thinks or feels. "The universe existed before humans did" was true before any human thought it. We don't create truth. We discover it. This means two contradictory claims cannot both be true. Either God exists or He doesn't. Either Jesus rose or He didn't. Reality doesn't bend to preference.`,
      },
      {
        head: `How Do We Know Truth? — Three Channels`,
        body: `It's not enough to prove truth exists — we need to show it's accessible. Through our senses: we observe the physical world and draw reliable conclusions. Science works because reality behaves in ways we can measure and test. Through reason: logic allows us to move from what we observe to conclusions we cannot directly see. Through testimony: we accept truths we cannot personally verify by trusting reliable witnesses. You know World War II happened not because you were there, but because the evidence and testimony are overwhelming. These three channels — sense, reason, and testimony — are sufficient to examine the claims of Christianity.`,
      },
      {
        head: `The Major "Isms" — All Self-Defeating`,
        body: `Every major alternative worldview that rejects knowable truth ends up using truth to reject it. Relativism says "all truth is relative" — is that statement relative, or absolutely true? Scepticism says "you can't know anything for certain" — are you certain about that? Agnosticism says "we can't know any truths about religion" — is that a truth about religion? Pluralism says "all religions are equally true" — that is itself an absolute truth claim. Postmodernism says "truth is a social construct" — is that itself socially constructed, or objectively true? Scientism says "only science gives us truth" — that claim cannot be proven by science. Subjectivism says "truth is whatever feels true to me" — does everyone's subjective truth equally apply, including those who say subjectivism is false? Geisler's conclusion is devastating: you cannot escape truth by using truth to deny it.`,
      },
      {
        head: `Religious Truth Is Knowable — By the Same Standard`,
        body: `There is no special exemption for religious claims. Religious truth is subject to the same tests as any other truth claim: does it correspond to reality, is it internally consistent, and does the evidence support it? When people say "you can't know religious truth," they're applying a standard to religion they don't apply anywhere else. That's not scepticism — it's a double standard. Christianity does not ask for blind faith. It submits itself to examination — historical, logical, and evidential. The rest of this quest is that examination.`,
      },
    ],
    objections: [
      {
        head: `"But religion is just faith, not facts"`,
        body: `This assumes a sharp divide between faith and evidence that the Bible itself doesn't make. Luke opens his Gospel by saying he investigated everything carefully. Paul appeals to 500 eyewitnesses of the resurrection. Biblical faith is not belief without evidence — it is trust based on evidence.`,
      },
      {
        head: `"Different cultures have different truths"`,
        body: `Different cultures have different customs, values, and perspectives — that is true. But customs are not the same as truth claims. The claim "Jesus rose from the dead" is not a cultural preference — it is a historical claim that either happened or didn't, regardless of which culture you belong to.`,
      },
    ],
    deepDive: [
      {
    ...
    insight: `Every worldview that tries to place religious truth beyond examination ends up in self-defeat. The agnostic who says "we can't know any truths about religion" is making a truth claim about religion. The pluralist who says "all religions are equally true" is asserting an absolute truth. Geisler's point is not aggressive — it is the precondition of honest inquiry. If truth is knowable, then "Is Christianity true?" is a legitimate question — and it deserves a real answer.`,
    reflect: `Which of the "isms" have you heard — or believed yourself? Run it through the self-defeating test: is the claim itself self-defeating?`,
