    ...
    objections: [
      {
        ...
        body: `Geisler distinguishes three kinds of beings: self-caused (logically impossible — you'd have to exist before you exist to cause yourself), caused (contingent things that began to exist), and uncaused (exists by the necessity of its own nature, never began). The cosmological argument states: "everything that begins to exist has a cause" — not "everything." God, being eternal, never began. Asking "who made God?" is a category mistake — like asking what is north of the North Pole. You are applying causation to the very thing defined as being outside causation.`,
      },
      {
        head: `"The universe just exists" — The Atheist's Same Problem`,
        body: `Many atheists argue the universe simply exists without a cause. But notice: this is doing precisely what they accuse the theist of doing with God — asserting something uncaused. Both positions require something uncaused at the foundation. The real question is: what is it? Here the theist has a decisive advantage. The scientific evidence — the Big Bang, thermodynamics, the universe expanding from a singularity — shows the universe had a beginning, which means it cannot be the uncaused foundation it is claimed to be. An uncaused God existing outside time and space faces no such contradiction.`,
      },
    ],
    deepDive: [
      {
