...
export const POINTS: Point[] = [
  ...
  },
  {
    ...
    highlightMsg: `This isn't blind faith — it's the logical conclusion of everything the evidence has established. Stage 9 is the verdict.`,
    highlightMsgs: {
      jesus: `You've seen the claim and the evidence across eight stages. This is where the case closes. The conclusion follows with logical necessity — and it demands a response.`,
      inherited: `This is where inherited belief becomes owned conviction — not because you were told, but because the evidence points here and you have chosen to follow it honestly.`,
    },
    takeaway: `Stage 9 is not another argument. It is the verdict. Eight stages have built the case. The conclusion follows with logical necessity — and a conclusion this significant does not just inform. It demands a response.`,
    claim: `Eight stages have built the case. Stage 1 established that truth is knowable. Stage 2 that logic holds. Stage 3 that God exists. Stage 4 that miracles are possible. Stage 5 that miracles confirm God's messengers. Stage 6 that the New Testament is historically reliable. Stage 7 that Jesus claimed to be God. Stage 8 that the evidence — prophecy, empty tomb, appearances, hostile converts, church explosion — confirms that claim. Stage 9 is not another argument. Stage 9 is the verdict. The question is no longer whether there is evidence. The question is what you do with the evidence you have.`,
    sg: `Many Singaporeans at this point will say: "I need more time," or "I'm not sure yet," or "I respect the argument but I'm not ready to commit." These are understandable responses — but they need to be examined honestly. Continued scepticism after eight stages of evidence is no longer a neutral position. It is a choice. And like all choices, it has consequences. Selective scepticism — accepting evidence when it is convenient, withholding verdict when it demands something — is not intellectual honesty. It is avoidance dressed as caution. The evidence has been laid out. The alternatives have been examined. The verdict follows.`,
    specialViz: 'attributes',
    geisler: [
      {
        head: `The Syllogism — Five Steps to One Conclusion`,
        body: `Geisler's argument reaches its logical destination in five steps, each established in prior stages. First: a miracle-working God confirms his messengers — established in Stage 5. Second: Jesus performed miracles in God's name, culminating in resurrection — established in Stage 8. Third: therefore God has confirmed Jesus as his messenger. Fourth: Jesus claimed to be God — established in Stage 7. Fifth: therefore Jesus is God. Each premise has been tested against the historical and philosophical evidence. If any premise falls, the conclusion falls with it. But each premise holds. The conclusion follows with logical necessity. This is not a leap of faith. This is the end of a chain of reasoning — and the chain is complete.`,
      },
      {
        head: `No Competing Hypothesis Survives`,
        body: `Every alternative to "Jesus is God" has been examined and found wanting. The legend theory requires more time than the evidence allows — the resurrection was being preached in Jerusalem within weeks. The hallucination theory cannot account for 500 simultaneous witnesses or the empty tomb. The conspiracy theory collapses against the testimony of hostile converts — James and Paul had nothing to gain and everything to lose. The swoon theory is medically impossible. The "great moral teacher" option was eliminated in Stage 7 — the trilemma leaves no comfortable middle ground. When you have eliminated the impossible, whatever remains — however demanding its implications — must be the truth.`,
      },
      {
        head: `What the Incarnation Actually Means`,
        body: `To say Jesus is God is not to say there are two Gods, or that Jesus is a lesser divine being. It is to say that the one eternal God — who created space, time, and matter — took on a human nature in the person of Jesus of Nazareth. As God, Jesus performed miracles, forgave sins, and rose from the dead. As man, he grew up (Luke 2:40), got tired (John 4:6), wept (John 11:35), and died. These are not contradictions — they are what the incarnation means. God did not stop being God. He added a human nature to his divine one. The Council of Chalcedon (AD 451) articulated what the NT implies: one person, two natures — fully divine and fully human — without confusion or mixture. This is not a theological technicality. It is the most extraordinary event in human history: the Creator entering his creation.`,
      },
      {
        head: `The Personal Implications — The Verdict Demands a Response`,
        body: `If Jesus is God, the implications are total — not peripheral, not optional, not confined to Sunday mornings. If Jesus is God, then his words carry absolute authority. Everything he said about sin, forgiveness, eternity, and the way to the Father is true — not as one opinion among many, but as the words of the one who made you and knows you fully. If Jesus is God, then his death on the cross is not a tragedy or a martyrdom — it is atonement. Real guilt, dealt with by real sacrifice, offering real forgiveness. The weight you carry is not permanent. If Jesus is God, then his resurrection is not an isolated miracle — it is the firstfruit of a new creation. Death is not the final word on your life. The future is open in a way that nothing else makes possible. And if Jesus is God, then his claim on your life is total. Not a set of rules to follow at a distance. A person to know, follow, and belong to. The evidence does not just inform. It calls.`,
      },
    ],
    objections: [
      {
        head: `"I accept the argument but I'm not ready to commit"`,
        body: `This is the most honest and most common response at Stage 9 — and it deserves a direct answer. Intellectual acceptance and personal commitment are different things, and the gap between them is real. But consider what is being withheld. If the argument is sound — if Jesus is God — then continued delay is not caution. It is a choice to remain on the wrong side of the most important question in human existence. Jesus himself said: "Whoever is not with me is against me" (Matthew 12:30). There is no permanently neutral position. The question is not whether you will decide — it is whether you will decide deliberately or by default.`,
      },
      {
        head: `"How can Jesus be God if God is one?"`,
        body: `This is the Trinitarian question — and it is a fair one. The Christian answer is not that there are three Gods, but that the one God exists in three persons: Father, Son, and Holy Spirit. This is not a contradiction — three persons sharing one divine nature is different from three separate Gods. It is admittedly mysterious — but mystery is not the same as contradiction (Stage 2 established the difference). The NT affirms both the oneness of God (Deuteronomy 6:4, quoted by Jesus in Mark 12:29) and the divinity of Jesus (John 1:1, Colossians 2:9, Hebrews 1:8). The doctrine of the Trinity is the only coherent way to hold both together.`,
      },
    ],
    deepDive: [
      {
        head: `One Person, Two Natures — Chalcedon Explained`,
        body: `The Council of Chalcedon (AD 451) responded to various distortions of Christ's identity by affirming: Jesus Christ is one person in two complete natures — fully divine and fully human — without confusion, mixture, separation, or division. This rules out four errors: Nestorianism (two separate persons), Eutychianism (the two natures merge into one), Docetism (he only appeared human), and Arianism (he is a lesser divine being). The Chalcedonian definition is not a philosophical invention — it is the most precise articulation of what the NT consistently implies. Jesus is not 50% God and 50% man. He is 100% God and 100% man — one person, two natures, forever.`,
      },
      {
        head: `The Honour Due to the Son`,
        body: `Jesus said: "Whoever does not honour the Son does not honour the Father who sent him" (John 5:23). For a first-century Jewish man to claim he deserved the same honour as God Almighty was either the most outrageous blasphemy imaginable — or the plainest possible statement of identity. His opponents treated it as blasphemy. His disciples treated it as identity. Pilate found no fault in him. His executioners were converted at the cross (Mark 15:39). The women who first saw him risen worshipped him (Matthew 28:9). The only question is which response was correct.`,
      },
      {
        head: `Why This Conclusion Changes Everything`,
        body: `C.S. Lewis wrote: "Christianity, if false, is of no importance, and if true, of infinite importance. The only thing it cannot be is moderately important." If the argument of these nine stages is correct — if Jesus is God — then no other question in human life is more important. Not career, not relationships, not health, not success. All of those are real and matter. But they are all temporary. The question of who Jesus is determines your relationship with the eternal God who made you, sustains you, and will one day judge you. A person who ignores this question is not being neutral. They are making a decision by default — and it is the most consequential decision they will ever make.`,
      },
    ],
    insight: `Faith is not a leap in the dark — it is a step in the light, taken after the evidence has been examined. Eight stages of evidence point to one conclusion: Jesus is God. That conclusion does not float above your life at a safe intellectual distance. It descends into every corner of it — your identity, your guilt, your future, your relationships, your death. The verdict has been reached. The only question remaining is what you will do with it.`,
    reflect: `The evidence has been examined. The case has been made. What is your verdict — and what does it cost you to say it honestly?`,
    verses: ['John 1:1', 'John 1:14', 'Colossians 2:9', 'Philippians 2:6-8'],
    scripture: `"For in Christ all the fullness of the Deity lives in bodily form." — Colossians 2:9`,
    ref: 'Colossians 2:9',
  },
  {
    n: 10,
    ...
    highlightMsg: `Once you accept that Jesus is God, pick-and-choose is over — all of his words carry the same divine authority.`,
    highlightMsgs: {
      ...
      defense: `This is the logical hinge: Jesus is God → his teachings are true → his endorsement of Scripture carries divine weight. Stage 11 follows from here.`,
    },
    takeaway: `If Jesus is God, you cannot accept the comforting teachings and discard the costly ones — the authority is the same for all of them.`,
    claim: `Stage 9 delivered the verdict: Jesus is God. Stage 10 asks what follows immediately from that verdict. If Jesus is truly God — not merely a wise teacher, not a spiritual guru, not one voice among many — then every word he spoke carries a weight unlike anything else ever said by any human being. The question is no longer whether his teaching is helpful or appealing. The question is whether, being God, he can be wrong. And the answer is no.`,
    sg: `Singaporeans are pragmatic — we want to know what this means for how we actually live. If Jesus is God, his teachings are not a lifestyle option or a spiritual framework to be adopted selectively. His statements about forgiveness, eternal life, the nature of sin, the exclusive path to the Father, the reality of judgment — these are not religious opinions from a first-century rabbi. They are authoritative truth from the one who created the universe and knows you completely. That reframes everything: career, money, relationships, identity, sexuality, death.`,
    specialViz: null,
    geisler: [
      {
        head: `The Challenge: Pick-and-Choose Jesus`,
        body: `Most people who respect Jesus apply an unconscious filter to his teaching. They keep the parts that feel inclusive and comforting — love your neighbour, forgive one another, care for the poor. They quietly set aside the parts that are exclusive and costly — "I am the only way to the Father," "deny yourself and take up your cross," "unless you repent you will perish," "it is easier for a camel to go through the eye of a needle than for a rich man to enter the kingdom of God." This pick-and-choose approach makes perfect sense if Jesus is merely human — a wise teacher whose ideas can be evaluated and filtered like any other. But it becomes logically incoherent the moment you accept that he is God. You cannot say "I accept Jesus as God" and then edit his teaching. The authority is the same for all of it.`,
      },
      {
        head: `God Cannot Lie or Be Mistaken`,
        body: `The logical foundation of this stage: God is omniscient — he cannot be mistaken about any fact. God is perfectly good — he cannot intend to deceive. Therefore whatever God affirms is true, not as a high probability but as a necessity. Jesus, being God incarnate, spoke from perfect knowledge and perfect moral character. When he said "no one comes to the Father except through me" (John 14:6), he was not offering a personal opinion that might be revised in the light of cultural sensitivity. He was stating reality as only the Creator of reality can state it. As Scripture confirms: "it is impossible for God to lie" (Hebrews 6:18), "God is not a man, that he should lie" (Numbers 23:19), "God… cannot lie" (Titus 1:2).`,
      },
      {
        head: `The Comfortable AND the Costly — Both Are His`,
        body: `Jesus said things we love: "Come to me, all who are weary and burdened, and I will give you rest" (Matthew 11:28). "God so loved the world that he gave his one and only Son" (John 3:16). "Your sins are forgiven." But he also said things that cost everything: "Narrow is the gate and difficult is the way that leads to life, and few find it" (Matthew 7:14). "If anyone comes to me and does not hate his father and mother… he cannot be my disciple" (Luke 14:26). "You cannot serve both God and money" (Matthew 6:24). "Whoever is ashamed of me… of him will the Son of Man be ashamed" (Luke 9:26). The same authority is behind both sets of statements. If you accept the comfort, you must reckon with the cost. If he is God, you do not get to choose which Jesus to follow.`,
      },
      {
        head: `His Teaching Is One Coherent Whole`,
        body: `Jesus's teaching — from the Sermon on the Mount to John's farewell discourse — is internally consistent across every topic he addressed. Prayer, fasting, wealth, marriage, forgiveness, judgment, eternal life, the nature of God. It does not read like a compilation of opinions from different hands — it reads like one authoritative mind, speaking from complete knowledge of the human condition and perfect understanding of the Father. No philosopher, no guru, no prophet speaks with this combination of range, depth, internal consistency, and authority. Because no philosopher, guru, or prophet is God.`,
      },
      {
        head: `The Bridge to Scripture — What Jesus Said About the Bible`,
        body: `This stage sets up Stage 11 directly. Among the things Jesus taught with authority was his explicit endorsement of the Old Testament as the Word of God. He called it "the word of God" (Mark 7:13). He said "Scripture cannot be broken" (John 10:35). He said "until heaven and earth pass away, not an iota, not a dot, will pass from the Law until all is accomplished" (Matthew 5:18). He quoted it as the decisive authority in every debate — against the Pharisees, against the devil, in the synagogue at Nazareth. If Jesus is God, and God cannot lie, then his endorsement of Scripture carries the weight of the Creator's own verdict. That is where Stage 11 begins.`,
      },
    ],
    objections: [
      {
        head: `"Jesus's teaching was shaped by his first-century culture — it doesn't all apply today"`,
        body: `This objection assumes Jesus was a culturally conditioned human teacher whose views need updating. But the entire argument of this quest has established the opposite: Jesus is God incarnate. His teaching does not need cultural updating any more than the laws of mathematics do. He is the one who made human beings and knows what flourishing actually requires — not as a product of his era's assumptions, but as the Creator who designed the thing. This doesn't mean we apply every teaching woodenly without interpretation — context always matters — but it means the authority behind the teaching is not subject to revision by cultural preference.`,
      },
      {
        head: `"Some of Jesus's teachings contradict each other"`,
        body: `Apparent contradictions in Jesus's teaching consistently resolve under careful examination of context. "Judge not" (Matthew 7:1) and "judge with right judgment" (John 7:24) are not contradictory — the first forbids hypocritical condemnation, the second requires honest discernment. "I bring not peace but a sword" (Matthew 10:34) and "blessed are the peacemakers" (Matthew 5:9) address different domains — social division as a consequence of following him versus the character of his disciples. Careful reading eliminates the contradictions. What remains is a consistent, coherent whole.`,
      },
    ],
    deepDive: [
      {
        head: `Why God Cannot Lie — The Classical Argument`,
        body: `From classical theism: God is perfect being — the greatest conceivable reality. In order for a perfect being to change, it must either gain something it lacks or lose something it has. But God is perfect — there is nothing to add or subtract. Therefore God cannot change, and since lying or making errors would represent a departure from perfect truthfulness, God cannot lie. This is not an external constraint imposed on God — it flows from the very nature of what perfect being means. As Hebrews 6:18 states: "it is impossible for God to lie." His truthfulness is as necessary as his existence.`,
      },
      {
        head: `The Authority Behind the Sermon on the Mount`,
        body: `The Sermon on the Mount (Matthew 5-7) is widely admired even by those who don't accept Jesus's divinity. But notice the authority with which it is delivered. Moses said "the Lord commands..." Jesus said "you have heard it said... but I say to you." He places his own word above the Mosaic law — which, for a first-century Jew, was the very word of God. No prophet, no rabbi, no teacher in Jewish history spoke this way. The Sermon on the Mount only makes sense if the one delivering it is the same one who gave Moses the law in the first place.`,
      },
      {
        head: `What Divine Authority Means for the Hard Teachings`,
        body: `Jesus's hardest teachings — on money, sexuality, self-denial, and judgment — are not obstacles to faith. They are features of it. A God who told you only what you wanted to hear would not be God — he would be a projection of your preferences. The costly teachings of Jesus are evidence of their authenticity. They cut against comfort. They demand something real. A fabricated religion maximises appeal; Jesus minimises it: "Narrow is the gate." The difficulty of the teaching is not a reason to doubt its divine origin — it is a reason to take it seriously.`,
      },
    ],
    insight: `Many people want Jesus the comforter without Jesus the Lord. But the authority behind "come to me and I will give you rest" is the same authority behind "deny yourself and take up your cross." You cannot separate them. And the same authority that endorses his ethical teaching also endorses the Scriptures — which is where Stage 11 begins.`,
    reflect: `Is there a teaching of Jesus that you have been quietly setting aside? Name it honestly. Then ask: if he is truly God, what would it mean to take that teaching seriously?`,
    verses: ['John 14:6', 'Matthew 5:18', 'Hebrews 6:18', 'Luke 6:46'],
    scripture: `"Heaven and earth will pass away, but my words will never pass away." — Matthew 24:35`,
    ref: 'Matthew 24:35',
  },
  {
    n: 11,
    title: 'Jesus Taught That the Bible Is the Word of God',
    short: 'Bible Is God\'s Word',
    phase: 4,
    highlight: ['bible', 'defense'],
    highlightMsg: `Jesus personally endorsed the Old Testament as God's Word — and personally guaranteed the New Testament through the Holy Spirit.`,
    highlightMsgs: {
      bible: `This is where the Bible's authority is grounded — not in the church's decision, but in Jesus's own endorsement. If he is God, his word settles it.`,
      defense: `This is the logical chain: Jesus is God → God cannot lie → Jesus endorsed the OT and guaranteed the NT → therefore both carry divine authority.`,
    },
    takeaway: `You don't trust the Bible because the church approved it. You trust it because the One who rose from the dead endorsed it.`,
    claim: `Stage 10 established that Jesus's words carry absolute divine authority — and that he cannot lie or be mistaken. Stage 11 asks a specific question: what did Jesus himself say about the Bible? The answer comes in two parts. He authenticated the Old Testament that already existed. And in the Upper Room, the night before his crucifixion, he personally guaranteed the New Testament that was yet to be written — through the promise of the Holy Spirit. The entire Christian Bible rests on Jesus's own endorsement.`,
    sg: `In Singapore's educated, sceptical culture, the most common objection to the Bible's authority is institutional: "The church decided what was in the Bible — it's a human document shaped by politics and power." This objection is historically confused — but more importantly, it misses the point entirely. The Bible's authority does not rest on any church council. It rests on Jesus Christ — the one who authenticated the OT by calling it the word of God, and who guaranteed the NT by promising the Holy Spirit would lead his apostles into all truth. The question is not whether you trust the church. The question is whether you trust the one who rose from the dead.`,
    specialViz: null,
    geisler: [
      {
        head: `The Challenge: "The Bible Is a Human Document"`,
        body: `The most common objection to biblical authority is institutional: "Councils of men decided which books were in and which were out — the Bible is a human construction shaped by politics, power, and the winners of theological debates." This objection has a surface plausibility. Councils did meet. Discussions did happen. But the objection fundamentally mislocates where the Bible's authority comes from. Geisler's argument does not appeal to councils at all. It appeals to Jesus Christ — the one whose identity and resurrection have already been established. If Jesus is God and cannot lie, his endorsement of the Scriptures is the only authority that matters. Councils recognised Scripture; they did not create it.`,
      },
      {
        head: `Jesus Authenticated the Old Testament — In Four Ways`,
        body: `Jesus's endorsement of the Old Testament was explicit, repeated, and total. First, he called it "the word of God" directly — in Mark 7:13 he distinguished God's word from human tradition and sided unambiguously with God's word. Second, he declared "Scripture cannot be broken" (John 10:35) — an absolute affirmation of the OT's inviolable authority. Not some of it. Not the reliable parts. All of it. Third, he endorsed it to the letter — Matthew 5:17-18: "I have not come to abolish the Law or the Prophets but to fulfil them. Truly I tell you, until heaven and earth disappear, not the smallest letter, not the least stroke of a pen, will by any means disappear from the Law." The smallest letter in Hebrew is the yod — smaller than an apostrophe. Jesus staked his authority on the accuracy of the text down to the individual strokes. Fourth, he used it as the supreme authority in every debate — against Satan in the desert ("it is written" — three times), against the Pharisees, against the Sadducees. His consistent method was to appeal to Scripture as the final word that closed the argument.`,
      },
      {
        head: `Jesus Fulfilled the Old Testament — Staked His Identity on It`,
        body: `Jesus did not merely endorse the OT as a reliable ancient document. He staked his entire identity on it. Luke 24:27 records him walking with the disciples on the road to Emmaus after the resurrection: "Beginning with Moses and all the Prophets, he explained to them what was said in all the Scriptures concerning himself." He interpreted his own life, death, and resurrection as the fulfilment of everything the OT had pointed to. In Luke 24:44 he said: "Everything must be fulfilled that is written about me in the Law of Moses, the Prophets and the Psalms." If the OT were unreliable, Jesus's own identity would be groundless — he would be claiming to fulfil a document he had no confidence in. Instead, his confidence in it was total and his fulfilment of it was specific.`,
      },
      {
        head: `The Upper Room Discourse — Jesus Guaranteed the New Testament`,
        body: `The night before his crucifixion, Jesus gathered with his disciples in the upper room and delivered his most extended private teaching — John 13–17, known as the Upper Room Discourse. In it he made a promise that Geisler identifies as the divine guarantee of the New Testament. John 14:26: "But the Counsellor, the Holy Spirit, whom the Father will send in my name, will teach you all things and will remind you of everything I have said to you." Two functions: teach new truth and remind accurately of Jesus's words — the Gospels. John 16:12-13: "I have much more to say to you, more than you can now bear. But when he, the Spirit of truth, comes, he will guide you into all the truth. He will not speak on his own; he will speak only what he hears, and he will tell you what is yet to come." Three functions: guide into all truth — the Epistles; speak what he hears from the Father — divine origin; tell what is yet to come — Revelation and eschatological prophecy. Jesus did not leave the New Testament to human memory or theological development. He commissioned it, the night before his death, through the promised Holy Spirit.`,
      },
      {
        head: `The Two Testaments — One Divine Guarantee`,
        body: `Put it together. The Old Testament: Jesus called it the word of God, declared it cannot be broken, endorsed it to the letter, and staked his identity on its fulfilment. The New Testament: Jesus promised the Holy Spirit would remind the apostles of his exact words, teach them new truth they couldn't yet bear, and tell them what was yet to come. The entire Christian Bible — both Testaments — is covered by Jesus's own endorsement. Not the church's endorsement. Not a council's endorsement. The endorsement of the one who rose from the dead. As Geisler put it: the Bible's authority is derivative — it flows from the authority of Jesus. You don't trust the Bible because the church approved it. You trust it because the One who rose from the dead endorsed it.`,
      },
    ],
    objections: [
      {
        head: `"The canon was decided by church councils — it's a human choice"`,
        body: `This confuses recognition with creation. The Council of Nicaea (325 AD) dealt with Christological doctrine — not the biblical canon. The canon of the NT was effectively established by the second century, as evidenced by Irenaeus, Clement, and Origen quoting NT books as authoritative Scripture over a century before Nicaea. What councils did was formally recognise what the church had already identified — books bearing apostolic authority, consistent with accepted teaching, and widely received across the church. The church did not create Scripture's authority; it recognised it. And behind that authority is not a council's vote but Jesus's own promise.`,
      },
      {
        head: `"What about the books that were left out — the Gnostic Gospels?"`,
        body: `The so-called Gnostic Gospels — Thomas, Philip, Judas — were not excluded by a political conspiracy. They were evaluated against three criteria: apostolic authorship or connection (none of the Gnostic texts were written by apostles or their close associates), doctrinal consistency with the established teaching of Jesus (the Gnostic texts contradict it extensively), and widespread acceptance across the early church (the Gnostic texts were geographically and communally marginal). Every book excluded from the canon failed one or more of these tests on its own merits. The 27 books of the NT canon are not there because powerful men voted them in — they are there because they bear the marks of apostolic authority that Jesus promised the Holy Spirit would produce.`,
      },
    ],
    deepDive: [
      {
        head: `The Upper Room Promise — John 14-16 in Detail`,
        body: `The Upper Room Discourse (John 13–17) contains three specific promises about the Holy Spirit that together commission the NT. John 14:26 — "will teach you all things and remind you of everything I have said to you": the remind function guarantees the accuracy of the Gospels — the apostles' record of Jesus's words and deeds. John 15:26-27 — "the Spirit of truth… will testify about me. And you also must testify": the Spirit's testimony is linked with the apostolic testimony — the NT is the product of both. John 16:12-13 — "he will guide you into all the truth… he will tell you what is yet to come": all truth includes the full theological development of the Epistles; what is yet to come includes the prophetic content of Revelation. Jesus did not leave the production of the NT to chance or unaided human memory. He guaranteed it.`,
      },
      {
        head: `"Scripture Cannot Be Broken" — What Jesus Meant`,
        body: `John 10:35 contains perhaps the most precise statement Jesus ever made about biblical authority: "Scripture cannot be broken." The word "broken" (Greek: luo) means to loose, annul, or set aside — to treat as invalid. Jesus was saying that not a single text of the OT can be dismissed, annulled, or declared void. He made this statement in the middle of a theological argument — using a Psalm (Psalm 82:6) to make a point about his own identity. His logic depends entirely on the reliability of the Psalm. If the text can be questioned, the argument fails. Jesus's entire argumentative method assumed the OT's absolute trustworthiness — down to the individual words.`,
      },
      {
        head: `The Eyewitness Guarantee — Why the Apostles' Record Is Reliable`,
        body: `The Holy Spirit's promise to "remind" the apostles of Jesus's words (John 14:26) has a historical dimension. The apostles were eyewitnesses — men who had followed Jesus for three years, heard his teaching repeatedly, and watched him die and rise. The Holy Spirit's work was not to produce new memories but to ensure the accuracy of existing ones. This gives the Gospels a double guarantee: apostolic eyewitness testimony (Stage 6), and the promised work of the Holy Spirit (Stage 11). Luke, who was not one of the Twelve, investigated "carefully" and interviewed those who "were eyewitnesses from the first" (Luke 1:1-4). Paul received his gospel "by revelation from Jesus Christ" (Galatians 1:12). The NT is not the product of unaided human recollection — it is the product of eyewitness testimony operating under the guarantee Jesus made in the upper room.`,
      },
    ],
    insight: `The Bible's authority does not rest on any church council, any political decision, or any human institution. It rests on Jesus Christ — who called the OT the word of God that cannot be broken, and who promised the night before his death that the Holy Spirit would lead his apostles into all truth and tell them what was yet to come. If you trust Jesus — and Stages 1 through 10 have given you every reason to — you can trust the book he endorsed.`,
    reflect: `If Jesus personally guaranteed the New Testament through the Holy Spirit — as specifically as he promised his own resurrection — what would it mean to read the Bible as the word of the God who rose from the dead rather than as a human religious document?`,
    verses: ['John 10:35', 'Matthew 5:17-18', 'John 14:26', 'John 16:12-13', '2 Timothy 3:16'],
    scripture: `"Your word is truth." — John 17:17 | "Scripture cannot be broken." — John 10:35`,
    ref: 'John 10:35',
  },
  {
    n: 12,
    title: 'Therefore, the Bible Is the Word of God',
    short: 'Bible = Word of God',
    phase: 4,
    highlight: ['bible', 'defense', 'inherited'],
    highlightMsg: `The chain is complete. Stage 12 is where the argument becomes an invitation.`,
    highlightMsgs: {
      bible: `This is the destination your doubt was pointing toward. The Bible's authority isn't circular — it rests on the God who rose from the dead and endorsed it.`,
      defense: `The answer to "the Bible is just a human book" runs through 11 stages of evidence. This is where the chain completes — and the invitation opens.`,
      inherited: `You didn't inherit a fairy tale. You inherited a faith with a logical chain behind it. This stage shows every link — and what it means to respond.`,
    },
    takeaway: `The chain is complete. The Bible is the Word of God — grounded not in itself but in the God who rose from the dead and endorsed it. And the Word does not just inform. It calls.`,
    claim: `Eleven stages. One chain of evidence. Stage 12 is where it all arrives. Truth is knowable. Logic holds. God exists. Miracles are possible. Miracles confirm God's messengers. The New Testament is historically reliable. Jesus claimed to be God. The evidence confirms it. Jesus is God. His words carry absolute authority. He endorsed the Old Testament as God's Word and guaranteed the New Testament through the Holy Spirit. Therefore the Bible is the Word of God. The chain is complete. But Stage 12 is not the end of the chain. It is the beginning of a life.`,
    sg: `Singapore excels at acquiring credentials — degrees, certifications, titles. You work for them, earn them, display them. This is the one thing in human existence that cannot be earned. Only received. Singapore's achievement culture runs deep — but the Bible's message cuts against it at every point. It does not say achieve. It does not say qualify. It says: come. As you are. With everything you've done and failed to do. The God who created you, whose existence has been established through 12 stages of evidence, is not offering a merit-based system. He is offering grace. And grace, by definition, is not earned.`,
    specialViz: null,
    geisler: [
      {
        head: `The Chain Is Complete — Every Link Established`,
        body: `The argument reaches its conclusion through a chain in which every link has been independently evidenced. Stage 1: truth is knowable — self-defeating alternatives eliminated. Stage 2: logic holds — non-contradiction is unavoidable. Stage 3: God exists — cosmological, teleological, and moral arguments converge. Stage 4: miracles are possible — Hume's objection is circular. Stage 5: miracles confirm God's messengers — three tests, applied to Jesus. Stage 6: the NT is historically reliable — manuscript evidence, early dating, internal honesty, external corroboration. Stage 7: Jesus claimed to be God — explicitly, repeatedly, unmistakably. Stage 8: the evidence confirms the claim — prophecy, empty tomb, appearances, hostile converts, church explosion. Stage 9: therefore Jesus is God — the verdict. Stage 10: his words carry absolute authority — God cannot lie. Stage 11: he endorsed the OT and guaranteed the NT through the Holy Spirit. Stage 12: therefore the Bible is the Word of God. Each link was tested. Each link holds. The conclusion follows with logical necessity.`,
      },
      {
        head: `What "God-Breathed" Means`,
        body: `2 Timothy 3:16 says "all Scripture is God-breathed" — in Greek, theopneustos. This does not mean God mechanically dictated words to passive human secretaries. It means the Holy Spirit superintended the writing of Scripture — working through the personalities, styles, research, and experiences of the human authors — so that the result was precisely what God intended. Moses writes like a legislator. David writes like a poet. Luke writes like a careful historian. Paul writes like a trained theologian. Each human voice is distinct — yet behind every one is the same divine Author. This is what Geisler calls plenary verbal inspiration: all of it (plenary), including the words (verbal), breathed out by God.`,
      },
      {
        head: `The Bible Is Alive — Not a Historical Relic`,
        body: `Hebrews 4:12 describes the Word of God as "living and active, sharper than any double-edged sword, penetrating even to dividing soul and spirit, joints and marrow, and judging the thoughts and attitudes of the heart." This is not a description of an ancient religious text — it is a description of an ongoing address from a living God. The same Holy Spirit who inspired the writing of Scripture illuminates it for every reader in every generation. Reading the Bible is not an academic exercise. It is an encounter with the God who knows you completely — and who speaks to exactly where you are.`,
      },
      {
        head: `The Gospel — The Destination of the Entire Argument`,
        body: `The twelve-stage argument was never merely intellectual. It was always leading here. The God who exists (Stage 3) is not a distant creator who set the universe in motion and stepped away. He is a personal God who knows you, who made you for relationship with himself, and who sees the full reality of your life — including the gap between who you are and who you were made to be. That gap is what the Bible calls sin — not merely bad behaviour, but a fundamental break in the relationship between the creature and the Creator. The penalty for that break is separation from the source of all life (Romans 6:23). No achievement, no moral improvement, no religious performance can close it. This is why the chain of evidence leads to the cross. Jesus — the God-man established across Stages 7-9 — came not merely to teach but to die. His death was not a tragedy or a martyrdom. It was atonement: the Creator bearing the penalty for the creature's rebellion, so that the creature could be restored. "God demonstrates his own love for us in this: while we were still sinners, Christ died for us" (Romans 5:8). And the resurrection — established in Stage 8 — confirms that the atonement was accepted, the penalty fully paid, death itself defeated. The invitation is now open. Not to try harder. Not to be good enough. To receive what has already been done. "For it is by grace you have been saved, through faith — and this is not from yourselves, it is the gift of God — not by works, so that no one can boast" (Ephesians 2:8-9).`,
      },
    ],
    objections: [
      {
        head: `"If the Bible is God's Word, why does God allow suffering?"`,
        body: `This is the most personal and most important objection to Christian theism — and it deserves a full answer rather than a dismissal. The Bible itself does not flinch from the question. Job, Psalms, Lamentations, and Revelation all wrestle with suffering honestly. Geisler's answer operates on several levels. First, God is not the author of evil — evil is a privation, a lack of good in creatures with free will. Second, God does not merely observe suffering from a distance — in Jesus he entered into it, experiencing rejection, betrayal, torture, and death. Third, the resurrection is God's answer to suffering: not an explanation but a reversal. Death is not the last word. The question "why does God allow this?" is transformed by the resurrection into "what will God do about this?" — and the answer is everything.`,
      },
      {
        head: `"I accept the argument intellectually but I don't feel anything"`,
        body: `This is an honest and important response. Feeling often follows decision rather than preceding it. The biblical invitation is not primarily to an emotional experience — it is to a commitment: "If you confess with your mouth that Jesus is Lord and believe in your heart that God raised him from the dead, you will be saved" (Romans 10:9). Believing in your heart, in the biblical sense, means trusting — acting on what you have concluded to be true. You do not need to feel certain before you can trust. Trust is what you exercise precisely when certainty is not yet full. Many who have committed to Christ report that the sense of God's presence followed their decision — not preceded it. Do not wait for a feeling. Act on the evidence.`,
      },
    ],
    deepDive: [
      {
        head: `Faith and Reason Are Not Opposites`,
        body: `Geisler defines belief as "the persuasion of the mind that a certain statement is true" and faith as "trust in what you believe to be true." Reason can challenge, supplement, or confirm faith — but when used well, reason is not faith's enemy. You cannot honestly believe something your mind has already rejected as certainly false. The twelve-point case is designed to give your mind reasons to believe — so that faith becomes reasoned trust rather than a leap in the dark. What the case cannot do is believe for you. The evidence points. The invitation is issued. The response is yours.`,
      },
      {
        head: `Inerrancy — What It Does and Doesn't Mean`,
        body: `Geisler holds that Scripture is inerrant — without error in everything it affirms. This does not mean every sentence is a scientific proposition. It does not mean poetry is to be read as literal description. It does not mean figures of speech are false. It means that Scripture, interpreted according to its genre and context, does not affirm anything that is false. Historical claims are historically true. Theological claims are theologically true. The Psalms express genuine human experience. The parables teach real truth through fiction. Inerrancy is not a straightjacket — it is a commitment to the honesty of the divine Author.`,
      },
      {
        head: `The Bible's Central Message — From Beginning to End`,
        body: `The Bible is not a collection of disconnected religious texts. It is one unified story with one central theme: God's redemption of a broken creation through Jesus Christ. The OT points forward — creation, fall, covenant, law, prophets, all anticipating the one who is coming. The Gospels record his arrival — the God-man who fulfils everything the OT pointed to. The Epistles explain the meaning of his life, death, and resurrection for those who trust him. Revelation describes the completion of everything — all things made new, the dwelling of God with his people, death and suffering abolished forever. From Genesis 1 to Revelation 22, it is one story. And the invitation to enter that story is extended to every person who reaches the end of this quest.`,
      },
    ],
    insight: `Norman Geisler said: "The goal of this quest is not just to believe, but to know — and to live for the One who is Truth." Twelve stages of evidence have led here. The God who created you has spoken — in the Old Testament he endorsed, in the New Testament he guaranteed through the Holy Spirit, and above all in the person of Jesus Christ, who rose from the dead to confirm that every word is true. The quest was never just intellectual. It was always an invitation. And the invitation is still open.`,
    reflect: `The evidence has been laid out across twelve stages. The God who exists sent his Son to die for you and rose to confirm it. The Bible — endorsed by the one who rose from the dead — extends the invitation now. What is your response?`,
    verses: ['2 Timothy 3:16-17', 'Hebrews 4:12', 'Romans 10:9', 'Ephesians 2:8-9'],
