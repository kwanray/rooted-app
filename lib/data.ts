...
export const POINTS: Point[] = [
  ...
  },
  {
    ...
    insight: `The resurrection is the central, falsifiable claim of Christianity. Paul himself says: "If Christ has not been raised, your faith is futile." Five independent lines of evidence — prophecy, empty tomb, appearances, hostile converts, church explosion — all point to the same conclusion. And every alternative explanation — swoon, hallucination, conspiracy, legend — collapses under the evidence. What remains, as Holmes would say, however improbable it may feel, must be the truth.`,
