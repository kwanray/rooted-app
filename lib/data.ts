...
export const POINTS: Point[] = [
  ...
  },
  {
    ...
    claim: `The existence of the universe, moral law, and design all converge on a theistic God.`,
    ...
    insight: `These three arguments converge independently. You don't need all three — any one of them is enough to warrant serious investigation. Many Singaporeans accept evolution and the Big Bang — both are consistent with a Creator who used natural processes.`,
  ...
  },
  {
    ...
    claim: `A God who created natural law has the authority to act within and beyond it.`,
  ...
  },
  {
    ...
    insight: `If you accept the historicity of Julius Caesar or Socrates — based on far weaker manuscript evidence — intellectual consistency requires you to take the NT seriously. Singaporeans trust data. The NT holds up under the same forensic standards applied to any ancient document — and outperforms them all.`,
    reflect: `What standard of evidence would you need to trust a historical claim? Apply that same standard to the New Testament.`,
  ...
  },
  {
    ...
    claim: `The evidence converges: if God exists, miracles are possible; the NT is reliable; Jesus claimed to be God; the evidence confirms it. Therefore Jesus is God.`,
    ...
    insight: `Faith is not a leap in the dark. It is a step in the light — taken after the evidence has been examined. Singaporeans are trained to reach conclusions from evidence — in science, law, engineering. Apply that same framework here. The evidence has been presented. What is your verdict?`,
  ...
  },
  {
    ...
    claim: `Jesus treated the Old Testament as the Word of God — and His authority guarantees the New Testament through the apostles He commissioned to write it.`,
    ...
    insight: `The authority of Scripture is derivative — it flows from the authority of Jesus. You don't trust the Bible because the church said so. You trust it because the One who rose from the dead endorsed it. In Singapore's legal system, a document is authoritative based on who issued it. Scripture's authority rests on the highest authority that exists.`,
  ...
  },
  {
    ...
    insight: `Norman Geisler said: "The goal of this quest is not just to believe, but to know — and to live for the One who is Truth." Singapore excels at acquiring knowledge and credentials. But this is the one credential that cannot be earned — only received. The Word calls you not to achieve, but to surrender.`,
